/**
 * Created by rahilvora on 7/22/16.
 * Question
 ...
 * first turn to remove the stones. Both of you are very clever and have optimal strategies for the game.
...
public class NimGame {
    public static void main(String args[]){
        System.out.print(new NimGame().canWinNim(5));
    }
